package company.saifPro.TestBases;
...
import company.saifPro.Excel_ExcelReaders.Excel_reader;
...
public class TestBaby {
	...
	static {
		...
		extent = new ExtentReports(System.getProperty("user.dir") + "/src/main/java/company/saifPro/report/test" + formater.format(calendar.getTime()) + ".html", false);
	}
...
public String getScreenShot(String imageName) throws IOException{
	...
	String imagelocation = System.getProperty("user.dir")+"/src/main/java/company/saifPro/screenshot/";
	Calendar calendar = Calendar.getInstance();
	SimpleDateFormat formater = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss");
...
public String[][] getData(String excelName, String sheetName){
	System.out.println(System.getProperty("user.dir"));
	String excellocation = System.getProperty("user.dir")+"/src/main/java/company/saifPro/Testdata/"+excelName;
